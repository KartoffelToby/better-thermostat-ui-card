              ...
              <div id="controls">
                <div id="slider" class="${t.attributes.window_open?"window":""}">
                  ...
                  <div id="slider-center">
                    <div id="bt_status">
                    ${t.attributes.window_open&&"none"!==t.attributes.window_open&&"unavailable"!==t.state?this._renderStatusIcon("window_open",!0):this._renderStatusIcon("window_open",!1)}
                    ${t.attributes.call_for_heat||"none"===t.attributes.call_for_heat||"unavailable"===t.state?this._renderStatusIcon("summer",!1):this._renderStatusIcon("summer",!0)}
                    </div>
